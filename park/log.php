...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Log Parkir</h1>
      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tr>
				<?php 
					...
					$tampil = "select * from logmotor order by tanggal DESC LIMIT $posisi, $batas";
			...
			$jml_data = mysql_num_rows(mysql_query("SELECT * FROM logmotor"));
