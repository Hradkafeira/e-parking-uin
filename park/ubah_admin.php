      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tr>
				<?php 
					...
					$tampil = "select NIP,Nama from admin LIMIT $posisi, $batas";
					...
					<tr bgcolor = "white">
						<td><?php echo $a; ?></td>
                        <td><?php echo $b; ?></td>
                        <td style="text-align:center"><a href = "ubah_profil_admin.php?ID=<?php echo $a; ?>">Ubah</a></td>
                        <td style="text-align:center"><a  href="hapus_admin.php?ID=<?php echo $a; ?>">Hapus</td>
					</tr>
                <?php }
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="hapus_admin.php?ID=<?php echo $a; ?>">Hapus</a>
        </div>
      </div>
    </div>
  </div>
