...
<?php 
	include("config.php");
	$sql = "SELECT Nama from operator WHERE NIP = $_SESSION[NIP]";
		...
		<div class="wsize1 bor1 bg1 p-t-50 p-b-45 p-l-15 p-r-15 respon1">
			...
			<form action="proses_keluar.php" method="POST">
				<div class="text-center">
					<div class="m-10">
					Welcome <a href="ubah_profil.php?ID=<?php echo $_SESSION['NIP']; ?>"><button type="button" class="btn btn-secondary"><?= $row['Nama']; ?></button></a>
					<a href="proses_logout.php">logout</a>
						<h2>Silakan input Id (Keluar)</h2>
						<div class="m-10">
							<input class="form-control" type="number" placeholder="Nomor Kartu" name="ID">
						</div>
				...
				<div class="text-center">
					<input type="submit" class="btn btn-primary fs-16 trans-04" value="submit">
				</div>
			</form>
			</div>
